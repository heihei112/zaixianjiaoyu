...
import com.atguigu.guli.common.base.utils.HttpClientUtils;
...
import com.atguigu.guli.service.cms.util.UcenterProperties;
...
public class ApiWxController {
    ...
    public String genQrConnect(HttpSession session){
        ...
        String qrcodeUri = String.format(baseUrl, ucenterProperties.getAppId(), redirectUri, state);

        return "redirect:" +qrcodeUri;
    }
    ...
    public String callback(String code, String state, HttpSession session){
        ...
        Member member = memberService.getByOneId(openid);
        if(member == null){
